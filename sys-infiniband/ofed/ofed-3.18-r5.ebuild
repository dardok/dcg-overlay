...
IUSE="dapl +diags ibacm mstflint +opensm perftest qperf rds srp libfabric ${IUSE_OFED_DRIVERS}"
...
RDEPEND="!sys-infiniband/openib
		...
		libfabric? ( sys-infiniband/libfabric:${SLOT} )
