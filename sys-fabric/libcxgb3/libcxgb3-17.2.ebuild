...
src_compile() {
	cmake-utils_src_compile cxgb3-rdmav${LIBVER}
}

src_install() {
	insinto /etc/libibverbs.d
	doins ${BUILD_DIR}/providers/cxgb3/cxgb3.driver

	insinto /usr/$(get_libdir)/libibverbs
	insopts -m0755
	doins ${BUILD_DIR}/lib/libcxgb3-rdmav${LIBVER}.so
}
